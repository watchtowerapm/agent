# Watchtower Laravel Agent Guidelines
...
- **Unrecoverable exceptions**: Use `Watchtower::unrecoverableExceptionOccurred()` for fatal errors
...
- **Config file**: Add new config options to `config/watchtower.php`
